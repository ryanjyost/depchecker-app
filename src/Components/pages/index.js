...
import _BasicStart from './basic/BasicStart/BasicStart';
import _BasicRepoUrl from './basic/BasicRepoUrl';
import _BasicResults from './basic/BasicResults';
import _BasicUploadFile from './basic/BasicUploadFile';
import _BasicPasteCode from './basic/BasicPasteCode';
...
export const BasicUploadFile = _BasicUploadFile;
export const BasicPasteCode = _BasicPasteCode;
